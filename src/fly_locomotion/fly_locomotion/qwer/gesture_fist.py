...
class IntegratedLocomotion(Node):
    def __init__(self):
        ...
        self.model = tf.keras.models.load_model(
            "/home/hoon/Downloads/model_mlp_fist_via.h5"
        )
    ...
    def player_pose_callback(self, msg: PoseStamped):
        ...
        self.player_pose = np.array([[rot_matrix[0][0],rot_matrix[0][1],rot_matrix[0][2], position.x],
    ...
    def wrist_origin_callback(self, msg: PoseStamped):
        if self.player_pose is not None:
            ...
            wrist_pose = np.array([[rot_matrix[0][0],rot_matrix[0][1],rot_matrix[0][2], position.x],
                                        [rot_matrix[1][0],rot_matrix[1][1],rot_matrix[1][2], position.y],
                                        [rot_matrix[2][0],rot_matrix[2][1],rot_matrix[2][2], position.z],
                                        [0,0,0,1]])
    ...
    def calculate_translation_vel(self):
        ...
        print(f"Delta H: {delta_h}, Current Y: {current_pos[1]}, Initial Y: {self.initial_wrist_pos[1]}")
